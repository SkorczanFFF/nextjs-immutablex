          ...
          <div className={styles.modalWrapper}>
            ...
            <div className={styles.modalDescription}>
              ...
              <div className={styles.modalStats}>
                <p style={{marginRight: '1rem', color: '#a07500'}}><b>Attack: </b>{modalData?.metadata?.attack}</p> 
                <p style={{marginRight: '1rem', color: '#045D08'}}><b>Health: </b>{modalData?.metadata?.health}</p>
                <p style={{marginRight: '1rem', color: '#141A93'}}><b>Mana: </b>{modalData?.metadata?.mana}</p>       
              </div>
              <div className={styles.modalStats}>
                <span style={{marginRight: '1rem'}}><b>Quality: </b>{modalData?.metadata?.quality}</span> 
                <span style={{marginRight: '1rem'}}><b>Rarity: </b>{modalData?.metadata?.rarity}</span>
                <span style={{marginRight: '1rem'}}><b>Set: </b>{modalData?.metadata?.set}</span>  
                <span style={{marginRight: '1rem'}}><b>Type: </b>{modalData?.metadata?.type}</span>     
              </div>
